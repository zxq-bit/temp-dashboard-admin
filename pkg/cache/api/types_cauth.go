...
type User struct {
	...
	PasswordReset PasswordResetState `json:"passwordReset"`
}

// PasswordResetState defines the state of user's password
// Normal : user can aceess the system normally
// systemNew && systemReset : user will first set his password
type PasswordResetState string

const (
	Normal      PasswordResetState = "normal"
	SystemNew   PasswordResetState = "systemNew"
	SystemReset PasswordResetState = "systemReset"
)
...
type UserListOptions struct {
	...
	Invalid     string `json:"invalid" url:"query"`

	Remote   string `json:"remote" url:"query"`
	RemoteID string `json:"remoteId" url:"query"`

	Role   string `json:"role" url:"query"`
	Search string `json:"search" url:"query"`
